...
def compare_pixel_atm(rec_x, rec_y, flag):
    ...
    '''global coord_global
    coor_temp = []
    coor_temp.append(x_final)
    coor_temp.append(y_final)
    coor_temp.append(color_pixel)
    coord_global.append(coor_temp)'''
    ...
    #if shape_path == './shapes/rectangle.png':
...
class three_vibration_main_ui():
    def __init__(self, master):
        ...
        btn_confirm_vibration = tk.Button(self.three_vibration_main_frame, text='Confirm Vibration', width=42, height=5, bg='white')
