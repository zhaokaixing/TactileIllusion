...
'''
File used to study the effect of vibration durations on recognition accuracy -- Square Layout
'''
...
def write_csv(list_results):
    csv_file = open('vibration_duration_results_square.csv', 'a+')
...
def vibration_duration_compare_ui():
    ...
    root.title('Vibration Duration Comparison Square Layout')
    ...
    btn_start_vib = tk.Button(btn_technique_frame, text='Start Vibration', width=32, height=3, fg='white', bg='green', font=( "Helvetica", 11), command=click_btn_start_vib)
    btn_start_vib.pack()
    ...
    v_response.set(1)
    tk.Radiobutton(response_frame, text='1: Up', variable=v_response, value=1, font=("Helvetica", 11)).grid(row=0, column=1,
                                                                                                        ipadx=10)
    tk.Radiobutton(response_frame, text='2: Top Right', variable=v_response, value=2, font=("Helvetica", 11)).grid(row=0,
                                                                                                          column=2,
                                                                                                          ipadx=10)
    tk.Radiobutton(response_frame, text='3: Right', variable=v_response, value=3, font=("Helvetica", 11)).grid(row=0,
                                                                                                          column=3,
                                                                                                          ipadx=10)
    tk.Radiobutton(response_frame, text='4: Bottom Right', variable=v_response, value=4, font=("Helvetica", 11)).grid(row=0,
                                                                                                          column=4,
                                                                                                          ipadx=10)
    tk.Radiobutton(response_frame, text='5: Down', variable=v_response, value=5, font=("Helvetica", 11)).grid(row=2,
                                                                                                          column=1,
                                                                                                          ipadx=10)
    tk.Radiobutton(response_frame, text='6: Bottom Left', variable=v_response, value=6, font=("Helvetica", 11)).grid(row=2,
                                                                                                              column=2,
                                                                                                              ipadx=10)
